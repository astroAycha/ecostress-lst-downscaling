...
A Python-based geospatial workflow that uses machine learning to enhance
NASA ECOSTRESS land surface temperature (LST) data from 70 m to 10 m
resolution. The project demonstrates urban heat mapping and thermal
